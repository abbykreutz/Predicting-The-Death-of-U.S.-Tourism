...
**Abigail Kreutz** | **Peter Huang** | **Hope Tadsen**
...
Because the datasets covered different time periods, we evaluated both a **long-history dataset** and a separate **2020–2026 experiment** to investigate whether armed-conflict features added predictive value.
...
## My Contributions — Abigail Kreutz

My primary responsibility was the project's armed-conflict analysis and feature engineering, alongside broader debugging and validation of the shared modeling workflow.
...
* Contributed to secondary Random Forest and XGBoost experimentation and validation, including comparisons between short-history armed-conflict models and the long-history feature set.
...
Additional feature engineering, model refinement, validation, and experiments investigating armed-conflict features over the shorter period for which ACLED data were available.
...
The shorter history of armed-conflict data limited its usefulness for predictive modeling. Although politically violent events showed relationships with arrivals, COVID-19 strongly affected both series and made it difficult to isolate an independent effect. The long-history feature set ultimately generalized better.
...
* **Abigail Kreutz:** Armed-conflict EDA and data cleaning, feature engineering and validation, shared data/model debugging, and secondary Random Forest/XGBoost modeling and experimentation.
* **Hope Tadsen:** Repository creation, inbound tourism and GDP EDA and data cleaning, visual revisions, presentation consolidation, and report drafting.
